...
* You can turn on allowing mods to track if you've pressed certain buttons on your keyboard, which is off by default. This can only be turned on and used if runtime mod integration is on.
...
![image](/img/PB-PB-settings.png "An image of the PlumbBuddy app settings, with default settings")
